...
namespace CapaDatos
{
    public class Conexion_GestionHumana_Empleados
    {
        //Llaves Primarias
        ...
        public Conexion_GestionHumana_Empleados()
        {
        ...
        public string Guardar_DatosBasicos(Conexion_GestionHumana_Empleados Empleado)
        {
            string rpta = "";
        ...
        public string Editar_DatosBasicos(Conexion_GestionHumana_Empleados Empleado)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public String Eliminar_DatosBasicos(Conexion_GestionHumana_Empleados Empleados)
        {
        ...
        public DataTable Buscar_Empleado(Conexion_GestionHumana_Empleados Empleado)
        {
